...
def main():
    ...
    for grouping in groupings_list:
        ...
        grouped_matrix.write_text(name, 's_VOAP_0-6_Group-Results/' + name, True)
        grouped_matrix.write_csv(name, 's_VOAP_0-6_Group-Results/' + name)
        grouped_matrix.write_json(name, 's_VOAP_0-6_Group-Results/' + name)
